...
var Comunicacion = /*#__PURE__*/function () {
  function Comunicacion(id_comunicacion, id_remite, id_destino, id_alumnoAsociado, asunto, texto, importante, fecha, leida, eliminado, estado, nombre_alumnoAsociado, nombre_remite, nombre_destino, adjuntos) {
    (0, _classCallCheck2["default"])(this, Comunicacion);
    ;
    this.id_comunicacion = id_comunicacion, this.id_remite = id_remite, this.id_destino = id_destino, this.tipo_remite = null, this.tipo_destino = null, this.id_alumnoAsociado = id_alumnoAsociado, this.asunto = asunto, this.texto = texto, this.importante = importante, this.fecha = fecha, this.leida = leida, this.eliminado = eliminado, this.estado = estado, this.nombre_alumnoAsociado = nombre_alumnoAsociado, this.nombre_remite = nombre_remite, this.nombre_destino = nombre_destino, this.adjuntos = adjuntos;
