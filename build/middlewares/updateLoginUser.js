            ...
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                return (0, _database.executeQuery)(
                  'SELECT accesos FROM familias WHERE id = '.concat(userId)
                )
              ...
              case 3:
                ...
                return (0, _database.executeQuery)(
                  'UPDATE familias SET accesos = '
                    .concat(intAccesos[0].accesos + 1, ' WHERE id = ')
                    .concat(userId)
                )
              ...
              case 6:
                ...
                _context.next = 9
                return (0, _database.executeQuery)(
                  "UPDATE familias SET ip = '"
                    .concat(userIp, "' WHERE id = ")
                    .concat(userId)
                )
              ...
              case 9:
                ...
                _context.next = 12
                return (0, _database.executeQuery)(
                  "UPDATE familias SET navegador = '"
                    .concat(device, "' WHERE id = ")
                    .concat(userId)
                )
              ...
              case 12:
                ...
                _context.next = 16
                return (0, _database.executeQuery)(
                  "UPDATE familias SET ultimo = '"
                    .concat(date, "' WHERE id = ")
                    .concat(userId)
                )
