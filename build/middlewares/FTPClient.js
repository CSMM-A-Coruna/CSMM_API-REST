...
var FTPClient = /*#__PURE__*/ (function () {
  function FTPClient() {
    var host =
      arguments.length > 0 && arguments[0] !== undefined
        ? arguments[0]
        : 'csmm-es.espacioseguro.com'
    var port =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 21
    var username =
  ...
  ;(0, _createClass2['default'])(FTPClient, [
    ...
    },
    {
      key: 'makeDir',
      value: (function () {
        var _makeDir = (0, _asyncToGenerator2['default'])(
                      ...
                      c.on('ready', function () {
                        c.mkdir(
                          ...
                          function (err) {
                            if (
                              err &&
                              err != 'Error: Create directory operation failed.'
                            ) {
                              console.log(err)
                            }
                            ...
                            var cacheDir =
                              ...
                              fileName
                            var ftpDir =
                              '/adjuntos/' + idComunicacion + '/' + fileName
    ...
    },
    {
      key: 'cacheFile',
      value: (function () {
        var _cacheFile = (0, _asyncToGenerator2['default'])(
