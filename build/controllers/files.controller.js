      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 9;
            return ftp.uploadFile(req.query.id_comunicacion, req.file.originalname);

          case 9:
            uploadFileToFtp = _context.sent;
            _context.next = 12;
            return (0, _database.executeQuery)("INSERT INTO comunicaciones_adjuntos (idcomunicacion, adjunto) VALUES (".concat(req.query.id_comunicacion, ", '").concat(req.file.originalname, "')"));
          ...
          case 16:
            ...
            return _context.abrupt("return", res.status(413).json({
...
var downloadFile = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
    var fileName, directoryPath, ftp, cacheFile;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            directoryPath = __basedir + '/resources/downloads/' + req.query.id_comunicacion;
            ftp = new _FTPClient["default"]();
            _context2.next = 6;
            return ftp.cacheFile('/adjuntos/' + req.query.id_comunicacion + '/' + fileName, fileName, req.query.id_comunicacion);

          case 6:
            cacheFile = _context2.sent;
